...
public class MainTest {
    ...
    void testOnlyOneCase() {
        String[] args = buildArgs("func0", "func0singleTest", "f0multipleWrong");
     ...
     */
    private String[] buildArgs(String funcName, String configName, String implDir) {
     ...
     */
    private Set<TestCase> runMain(String[] args) {
     ...
     */
    private void mainTestHelper(String[] args, Set<TestCase> expected) {
     ...
     */
    private void mainTestMultipleOptionsHelper(String[] args,
     ...
     */
    private Map<Set<TestCase>, Double> buildDistribution(String[] args, int numTrials)
