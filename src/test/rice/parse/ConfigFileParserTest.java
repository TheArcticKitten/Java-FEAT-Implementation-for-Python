...
class ConfigFileParserTest {
    ...
    private static void setUpOneFloat() {
        ...
        oneFloatNode.setExDomain(Arrays.asList(-2f, -1f, 0f, 1f, 2f));
        oneFloatNode.setRanDomain(Arrays.asList(
            -5f, -4f, -3f, -2f, -1f, 0f, 1f, 2f, 3f, 4f, 5f));
    ...
    private static void setUpOneSet() {
        ...
        innerFloatNode.setExDomain(Arrays.asList(7f, 8f));
    ...
    private static void setUpMultipleSimple() {
        ...
        floatNode.setExDomain(Arrays.asList(0f, 1f));
        floatNode.setRanDomain(Arrays.asList(-1f, 0f, 1f));
    ...
    private static void setUpMultipleNested() {
        ...
        PyFloatNode innerFloatNode = new PyFloatNode();
        innerFloatNode.setExDomain(Arrays.asList(10f, 11f));
        innerFloatNode.setRanDomain(Arrays.asList(10f, 11f, 12f));
